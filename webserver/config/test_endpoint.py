...
# [ Options ]
domain = "https://web.physcorp.com/paul/endpoint.php"
...
r = requests.post(domain, data = {'name': 'HELP I AM TRAPPED IN A COMPUTER PLEASE LET ME OUT', 'score': 9001, 'game': 'Puzzle'})
